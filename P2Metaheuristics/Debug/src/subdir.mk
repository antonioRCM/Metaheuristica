...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I"/home/carlos/Informatica/docencia/Metaheuristicas/practicas/eclipseWorkspace/P2Metaheuristics/src/include" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
