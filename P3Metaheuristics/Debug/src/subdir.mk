...
src/%.o: ../src/%.cpp
	...
	g++ -std=c++0x -I"/home/carlos/Informatica/docencia/Metaheuristicas/practicas/eclipseWorkspace/P3Metaheuristics_complete/src/include" -O0 -g3 -pedantic -pedantic-errors -Wall -Wextra -Werror -Wconversion -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
